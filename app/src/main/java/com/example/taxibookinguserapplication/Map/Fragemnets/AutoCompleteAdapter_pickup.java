...
public class AutoCompleteAdapter_pickup extends ArrayAdapter<AutocompletePrediction> implements Filterable {

    List<AutocompletePrediction> mResultList;
    PlacesClient placesClient;

    public AutoCompleteAdapter_pickup(Context context, PlacesClient placesClient) {
    ...
    public List<AutocompletePrediction> getAutocomplete(CharSequence constraint) {
        ...
        final FindAutocompletePredictionsRequest.Builder requestBuilder =
                FindAutocompletePredictionsRequest.builder()
                        ...
                        .setCountry("AU") //Use only in specific country
